========================================================================
    KONSOLENANWENDUNG: NeuralTicTacToe-Projektübersicht
========================================================================

Diese NeuralTicTacToe-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre NeuralTicTacToe-Anwendung besteht.


NeuralTicTacToe.vcxproj
...
NeuralTicTacToe.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen NeuralTicTacToe.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
